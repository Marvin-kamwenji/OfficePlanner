//package com.officeplanner.officeplanner.Privilegees;
//
//import com.officeplanner.officeplanner.Dao.PrivilegeRepository;
...
//        Privilege writePrivilege = createPrivilegeIfNotFound("READ_PRIVILEGE");
//
//        List<Privilege> adminPrivileges = Arrays.asList(readPrivilege, writePrivilege);
//        createRoleIfNotFound("ROLE_ADMIN", adminPrivileges);
//        createRoleIfNotFound("ROLE_USER", Arrays.asList(readPrivilege));
//        createRoleIfNotFound("ROLE_OFFICER", Arrays.asList(writePrivilege));
//
